    ...
    return (
        <>
            ...
            <div className="flex flex-row p-2 rounded-sm bg-[#001524]/5 w-fit">
                {/*Date*/}
                <div className="flex flex-col justify-center items-center p-1 mr-[1rem] rounded-sm bg-[#672F2F]/70 w-[4rem] h-[4rem]">
                    <h1 className="text-[2rem] text-[#FAF5EF]/90"> 01 </h1>
                    <p className="text-[1rem] font-semibold text-[#001524]/70"> Jan </p>
                </div>
                {/*Name & Time */}
                <div className="self-center flex flex-col justify-start items-start mr-[3rem]">
